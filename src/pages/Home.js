  ...
  const features = [
    {
      ...
      description: "Giao hàng miễn phí toàn quốc cho đơn hàng từ 500k"
    },
    {
      icon: <FaShieldAlt className="w-8 h-8 text-primary-500" />,
      title: "Bảo hành chính hãng",
      description: "Bảo hành 12 tháng chính hãng, đổi trả trong 30 ngày"
    },
    {
    ...
    {
      icon: <FaGift className="w-8 h-8 text-primary-500" />,
      title: "Quà tặng hấp dẫn",
      description: "Tặng kèm phụ kiện và voucher giảm giá cho khách hàng"
    }
  ];
  ...
  const testimonials = [
    {
      ...
      content: "Kit Boong thực sự rất chất lượng! Tôi đã sử dụng được 2 năm và vẫn hoạt động tốt như mới.",
      rating: 5,
    ...
    },
    {
      name: "Trần Thị B",
      role: "Khách hàng mới",
      content: "Giao hàng nhanh, sản phẩm đúng như mô tả. Rất hài lòng với dịch vụ của Kit Boong!",
      rating: 5,
    ...
    },
    {
      name: "Lê Văn C",
      role: "Khách hàng VIP",
      content: "Chất lượng sản phẩm vượt trội, giá cả hợp lý. Đây là thương hiệu tôi tin tưởng nhất!",
      rating: 5,
        ...
        <div className="container-custom relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[600px] py-20">
            <div className="space-y-8">
              ...
              <h1 className="text-5xl lg:text-6xl font-bold text-gray-900 font-display leading-tight">
                Kit Boong
                <span className="block text-primary-600">Chất lượng hàng đầu</span>
              </h1>
              <p className="text-xl text-gray-600 leading-relaxed">
                Khám phá bộ sưu tập Kit Boong đa dạng với chất lượng cao cấp, 
                thiết kế hiện đại và giá cả hợp lý. Đáp ứng mọi nhu cầu của bạn.
              </p>
              ...
              <div className="flex items-center space-x-8 text-sm text-gray-600">
                <div className="flex items-center space-x-2">
                  ...
                  <span>4.8/5 từ 1000+ đánh giá</span>
                </div>
                <div className="flex items-center space-x-2">
        ...
        <div className="container-custom">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 font-display mb-4">
              Tại sao chọn Kit Boong?
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Chúng tôi cam kết mang đến những sản phẩm chất lượng nhất với dịch vụ khách hàng hoàn hảo
            </p>
          </div>
      ...
      <section className="section-padding bg-gray-50">
        <div className="container-custom">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Khám phá những sản phẩm Kit Boong được yêu thích nhất với chất lượng vượt trội
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Những đánh giá chân thực từ khách hàng đã sử dụng sản phẩm Kit Boong
            </p>
          </div>
      ...
      <section className="section-padding bg-gradient-to-r from-primary-600 to-secondary-600">
        <div className="container-custom text-center">
          ...
          <p className="text-xl text-primary-100 mb-8 max-w-2xl mx-auto">
            Đăng ký ngay để nhận thông báo về các sản phẩm mới và ưu đãi đặc biệt
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-md mx-auto">
            <input
              type="email"
              placeholder="Nhập email của bạn"
              className="flex-1 px-6 py-4 rounded-lg border-0 focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-primary-600"
            />
