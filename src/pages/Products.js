    ...
    const mockProducts = [
      {
        ...
        badge: "Bán chạy",
        category: "premium",
        description: "Kit Boong Premium với chất lượng cao cấp, thiết kế hiện đại"
      },
      {
        id: 2,
        ...
        badge: "Giảm giá",
        category: "deluxe",
        description: "Kit Boong Deluxe với giá cả hợp lý, chất lượng tốt"
      },
      {
        id: 3,
        ...
        badge: "Mới",
        category: "standard",
        description: "Kit Boong Standard phù hợp với mọi nhu cầu"
      },
      {
        id: 4,
        name: "Kit Boong Pro",
        ...
        badge: "Cao cấp",
        category: "pro",
        description: "Kit Boong Pro với tính năng đặc biệt, chất lượng vượt trội"
      },
      {
        id: 5,
        name: "Kit Boong Mini",
        ...
        badge: "Tiết kiệm",
        category: "mini",
        description: "Kit Boong Mini gọn nhẹ, tiện lợi"
      },
      {
        id: 6,
        name: "Kit Boong Max",
        ...
        badge: "Cao cấp",
        category: "max",
        description: "Kit Boong Max với công nghệ tiên tiến nhất"
      }
    ];
      ...
      <div className="bg-white shadow-sm">
        <div className="container-custom py-8">
          ...
          <p className="text-xl text-gray-600">
            Khám phá bộ sưu tập đa dạng với chất lượng cao cấp
          </p>
        </div>
      </div>
