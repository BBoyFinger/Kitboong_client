...
const Cart = () => {
  ...
  // Mock cart data - replace with context/API
  useEffect(() => {
    const mockCartItems = [
      {
        id: 1,
                  ...
                  <div key={item.id} className="flex items-center space-x-4 p-4 border border-gray-200 rounded-lg">
                    ...
                    <div className="flex items-center space-x-2">
                      <button
                        ...
                        className="w-8 h-8 border border-gray-300 rounded-lg flex items-center justify-center text-gray-600 hover:text-primary-600 hover:border-primary-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                      >
                        -
                      </button>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-xl shadow-lg p-6 sticky top-24">
              ...
              <button
                ...
                disabled={isLoading}
                className="w-full bg-primary-600 hover:bg-primary-700 text-white font-semibold py-4 px-6 rounded-lg transition-colors duration-300 disabled:opacity-50 disabled:cursor-not-allowed mt-6 flex items-center justify-center space-x-2"
              >
                {isLoading ? (
                  <>
              ...
              <div className="mt-6 text-sm text-gray-500 space-y-2">
                <div className="flex items-center space-x-2">
                  ...
                  <span>Giao hàng miễn phí cho đơn từ 500k</span>
                </div>
                <div className="flex items-center space-x-2">
